<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditProducts.aspx.cs" Inherits="MEWeb.Maintenance.EditProducts" %>
                                ...
                                var Row = HomeContainerTab.Helpers.DivC("row margin0");
                                {
                                    var RowCol = Row.Helpers.DivC("col-md-12");
                                    {
                                       /* RowCol.Helpers.HTML().Heading2("Editable Table");
                                        ...
                                        var MovieList = RowCol.Helpers.TableFor<MELib.Products.Product>((c) => c.ProductList, true, true);
                                        {
                                            MovieList.AddClass("table table-striped table-bordered table-hover");
                                            var MovieListRow = MovieList.FirstRow;
                                            {
                                                var ProductTitle = MovieListRow.AddColumn(c => c.ProductName);
                                                {
                                                    ProductTitle.Style.Width = "300px";
                                                }
                                                var MovieGenreID = MovieListRow.AddColumn(c => c.Price);
                                                {
                                                    MovieGenreID.Style.Width = "200px";
                                                }
                                                var ProductPath = MovieListRow.AddColumn(c => c.ProductImageURL);
                                                {
                                                    ProductPath.Style.Width = "300px";
                                                }
                                                var ProductCategory = MovieListRow.AddColumn(c => c.SubCategoryID);
                                                {
                                                    ProductCategory.Style.Width = "200px";
                                                }
                                                 var ProductAvailability = MovieListRow.AddColumn(c => c.IsActiveInd);
                                                {
                                                    ProductCategory.Style.Width = "200px";
                                                }
                                                var ProductQuantity = MovieListRow.AddColumn(c => c.Quantity);
                                                {
                                                    ProductCategory.Style.Width = "200px";
                                                }
