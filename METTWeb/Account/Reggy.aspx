<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLoggedOut.Master" AutoEventWireup="true" CodeBehind="Reggy.aspx.cs" Inherits="MEWeb.Account.Reggy" %>
    ...
    <%
        using(var h = this.Helpers)
        {
            ...
            var RegistrationDIv = h.Div();
            {
                ...
                //}
                var fieldSet =  RegistrationDIv.Helpers.FieldSetFor<MELib.User.User>("Registration", c => c.User);
                {
